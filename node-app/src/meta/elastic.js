    ...
    db.indices.putMapping({
        ...
        body: {
            properties: {
                ...
                msrp_enabled: {type: "text"},
                msrp_display_actual_price_type: {type: "text"},
                gift_message_available: {type: "text"},
                hzt_authenticity_guarantee: {type: "text"},
                hzt_freeshiping: {type: "text"},
                meta_autogenerate: {type: "text"},
                hzt_ringserie: {type: "text"},
                created_at: {
                    type: "date",
